...
export function InfoBar({ coins, win, combo, free }: Props) {
  ...
  return (
    <div className={styles.infoBar}>
      ...
      <div className={styles.infoBox}><div className={styles.infoLabel}>FREE</div><div className={styles.infoVal}>{free}</div></div>
    </div>
  );
}
